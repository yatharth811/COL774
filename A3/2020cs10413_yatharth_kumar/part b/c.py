...
if __name__ == '__main__':
    ...
    networks = [NeuralNetwork(X = X_train, Y = y_train_onehot, layers = network, activation = lambda z: 1 / (1 + np.exp(-z)), activation_derivative = lambda z: z * (1 - z), mini_batch_size=32, learning_rate=0.01, epochs=500, adaptive=False) for network in networks]
